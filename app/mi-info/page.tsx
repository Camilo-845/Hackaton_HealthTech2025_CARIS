...
import { ArrowLeft, Save, UserIcon, LogOut } from "lucide-react"
      ...
      <main className="px-4 py-6 space-y-6">
        ...
        <div className="text-center space-y-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Semana {formData.semanaGestacion} de gestación</p>
          </div>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleChange("talla", Number.parseInt(e.target.value))}
                    required
                    className="rounded-xl"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    type="number"
                    value={formData.peso}
                    onChange={(e) => handleChange("peso", Number.parseInt(e.target.value))}
                    required
                    className="rounded-xl"
                  />
                </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  La semana de gestación se calcula automáticamente desde esta fecha
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => handleChange("semanaGestacion", Number.parseInt(e.target.value))}
                  className="rounded-xl"
                />
                <p className="text-xs text-muted-foreground">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <Card className="border-2 bg-[#aeebb8]/10">
            <CardContent className="p-4 text-center">
              <p className="text-2xl font-bold">{40 - formData.semanaGestacion}</p>
